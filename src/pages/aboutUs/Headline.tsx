const Headline = (): JSX.Element => {
  return (
    <section className="flex flex-col w-[370px] md:w-[1280px] mx-auto py-12 gap-4 font-normal">
      <h1 className="w-full text-[26px] md:text-[58px] text-center text-balance font-inter">
      ...
      <p className="text-white text-base text-center p-2 md:p-0 md:leading-[150%] font-inter font-[12px] md:font-[16px] max-w-screen mx-auto self-stretch">
